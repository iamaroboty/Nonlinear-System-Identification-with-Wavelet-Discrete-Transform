function [en,S] = MSAFTERRA_adapt(un,dn,S,C)
...
U1_tot = zeros(K(1),N); % output of analysis filters for 1st order signal 
...
for i = 1:C
    ...
    U2_tot{i} = zeros(K(2)-i+1,N); % output of analysis filters for 2nd order signal 
end
